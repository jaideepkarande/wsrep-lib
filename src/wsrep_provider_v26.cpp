...
wsrep::wsrep_provider_v26::wsrep_provider_v26(
  ...
  std::memcpy(state_id.uuid.data, server_state.initial_position().id().data(),
...
void wsrep::wsrep_provider_v26::fetch_pfs_info(wsrep_node_info_t *nodes,
                                               uint32_t size)
{
